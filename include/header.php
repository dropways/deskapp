	...
	<div class="header">
		<div class="header-left">
			<div class="menu-icon fa fa-bars">
			</div>
		...
		<div class="right-sidebar-body">
			...
			<div class="sidebar-radio-group pb-30 mb-10">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="sidebaricon-1" name="icon" class="custom-control-input">
					<label class="custom-control-label" for="sidebaricon-1"><i class="fa fa-angle-down"></i></label>
				</div>
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="sidebaricon-2" name="icon" class="custom-control-input">
					<label class="custom-control-label" for="sidebaricon-2"><i class="ion-plus"></i></label>
				</div>
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" id="sidebaricon-3" name="icon" class="custom-control-input">
