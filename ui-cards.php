	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<h4 class="weight-500 mb-30">Navigation</h4>
				<div class="row clearfix">
				...
				<h4 class="weight-500 mb-30">Background and color</h4>
				<div class="row clearfix">
					<div class="col-md-4 col-sm-12 mb-30">
						<div class="card text-white bg-primary box-shadow">
					...
					<div class="col-md-4 col-sm-12 mb-30">
						<div class="card text-black bg-warning box-shadow">
							<div class="card-header">Header</div>
							<div class="card-body">
				...
				<h4 class="weight-500 mb-30">Card groups</h4>
				...
				<h4 class="weight-500 mb-30">Card decks</h4>
				...
				<h4 class="weight-500 mb-30">Card columns</h4>
